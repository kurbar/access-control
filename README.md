[![NPM Version](https://badge.fury.io/js/@kurbar/access-control.svg?style=flat)](https://npmjs.org/package/@kurbar/access-control) [![contributions welcome](https://img.shields.io/badge/contributions-welcome-brightgreen.svg?style=flat)](https://github.com/kurbar/access-control/issues)
...
- TypeScript support.
- **Note**:
  - For versions < 4.0: follow this [ReadMe](https://github.com/tensult/@kurbar/access-control/blob/6cde220e5d4956270c60f5fe58f84dcd8a257924/README.md).
